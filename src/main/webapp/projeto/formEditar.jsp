...
<body>
	...
	<div class="container">
		...
		<form method="post" name="myform" class="form-horizontal"
			action="<%=request.getContextPath()%>/projeto/atualizar">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="codeProject">código do projeto:</label>
				<div class="col-sm-5">
					<input type="text" name="codeProject" id="codeProject" value="${item.projectCode}"
