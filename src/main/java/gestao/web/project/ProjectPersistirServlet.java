...
@WebServlet("/projeto/persistir")
public class ProjectPersistirServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	private static final String FORM = "/projeto/formInserir.jsp";
	private static final String ERRO = "/publico/erro.jsp";
	private static final String DESTINO = "/projeto/listar.jsp";

	public ProjectPersistirServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ProjectDTO project = ProjectPersistirServlet.getProjectDTO(request);

		try {
			ProjectValidationService.validate(project);
			projectService.createProject(ProjectAdapter.dotoToRequestDto(project));
